...
class RegistrationForm:
    ...
    def do_registration(self, user_name : str = None,
                        user_last_name : str = None,
                        user_mail : str = None,
                        user_password : str = None,
                        user_password_repeat : str = None) -> Self:
    ...
    def fill_registration_fields(self, user_name : str,
                                 user_last_name : str,
                                 user_mail : str,
                                 user_password : str,
    ...
    def is_registration_failed_by_password_conditions(self) -> bool:
        try:
    ...
    def is_registration_failed_by_name_length(self) -> bool:
        try:
    ...
    def is_registration_failed_invalid_name(self) -> bool:
        try:
    ...
    def is_registration_failed_invalid_name_and_length(self) -> bool:
        try:
    ...
    def is_registration_failed_incorrect_mail(self) -> bool:
        try:
