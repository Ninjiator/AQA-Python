...
class TestBookingUpdate(TestBooking):
    def test_update_booking(self, b_payload, authorized_booking_client, create_booking_id):
        ...
        get_response = authorized_booking_client.get_booking(create_booking_id)
    ...
    def test_patch_booking(self, authorized_booking_client, create_booking_id):
        booking_payload = {
             "firstname": "Mikie",
             "lastname": "Howard"}
        response = authorized_booking_client.patch_booking(create_booking_id, booking_payload)
