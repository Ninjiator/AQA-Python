...
class TestDeleteBooking(TestsBooking):
    def test_delete_booking(self, booking_client, auth_cookie_token, create_booking_id):
        response = booking_client.delete_booking(create_booking_id, auth_cookie_token)
